...
Revision ID: e4147e49e6e1
Revises: 8d3dfb9b068d
Create Date: 2023-09-16 12:58:10.621579
...
revision: str = 'e4147e49e6e1'
down_revision: Union[str, None] = '8d3dfb9b068d'
...
def upgrade() -> None:
    ...
    op.alter_column('Tg_User', 'phone_number', type_=sa.BigInteger)
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column('Tg_User', 'phone_number', type_=sa.Integer)
